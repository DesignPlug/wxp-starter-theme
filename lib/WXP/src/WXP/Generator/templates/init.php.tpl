...
/*********************************************************
* Use this file for your theme's initiation, here is a good
* place to declare theme support, register menu locations. 
* thumbnail sizes, load text domains etc... {frameworkfn} comes
